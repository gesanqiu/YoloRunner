 ...
 * @LastEditTime: 2023-02-12 17:56:21
 */
...
void VideoPipeline::SetUserData(std::shared_ptr<SafeQueue<cv::Mat>> user_data)
{
    m_productQueue = user_data;
}

void VideoPipeline::SetUserData(std::shared_ptr<DoubleBufCache<std::vector<yolov5::Detection>>> user_data)
{
